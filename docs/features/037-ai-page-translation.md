...
**Status: Planned.** Reviewed against `4abb8f5` on 2026-09-23.

No AI provider or translation workflow is implemented. Everything below is a proposal; model names and dependency choices are historical suggestions, not supported configuration.
